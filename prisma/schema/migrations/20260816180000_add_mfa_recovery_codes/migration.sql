-- CreateTable: MfaRecoveryCode (§34) — User.mfaEnabled/mfaSecretCiphertext existent
-- deja au schema depuis la Phase 2, seuls les codes de secours manquaient une table.
