...
export const ROLE_PERMISSIONS: Record<string, readonly PermissionCode[]> = {
  ...
  DIRECTOR: ["students.read", "grades.read", "grades.publish", "attendance.read", "finance.read"],
  ACADEMIC_DIRECTOR: ["students.read", "grades.read", "grades.write", "grades.publish", "attendance.read"],
  ...
  SUPERVISOR: ["attendance.read", "attendance.write"],
  LIBRARIAN: [],
  TRANSPORT_MANAGER: [],
  TENANT_AUDITOR: ["students.read", "grades.read", "attendance.read", "finance.read"],
